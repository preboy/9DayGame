#include "stdafx.h"
#include "LibGraphics/AnimationEditor.h"
...
namespace LibGraphics
{
    ...
    BOOL CAnimationEditor::SaveToFile(const char* fileName)
    {
        ...
        m_aniHeader.dwAniSetCount = m_mapAniSets.size();
        m_aniHeader.dwTextureCount = m_vecTextures.size();
        ...
        for(auto it = m_mapAniSets.begin(); it != m_mapAniSets.end(); it++)
        {
            ...
            // 写帧数
            DWORD frameCount = it->second->m_vecFrames.size();
